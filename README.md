# Flatiron School Python/Flask Curriculum
...
- [{"basket": "ball"} Lab](https://github.com/learn-co-curriculum/python-p3-basket-ball)
...
- [How the Web Works](https://github.com/learn-co-curriculum/python-p4-how-the-web-works)
  - [Web Servers and WSGI](https://github.com/learn-co-curriculum/python-p4-web-servers-and-wsgi)
  - [Building Flask Applications](https://github.com/learn-co-curriculum/python-p4-flask-application-structure)
  - [Flask Routing and Views Lab](https://github.com/learn-co-curriculum/python-p4-routing-and-views-lab)
  - [The Request-Response Cycle](https://github.com/learn-co-curriculum/python-p4-request-response-cycle)
  - [Flask-SQLAlchemy](https://github.com/learn-co-curriculum/python-p4-flask-sqlalchemy)
  - [Flask-SQLAlchemy, Part 2](https://github.com/learn-co-curriculum/python-p4-flask-sqlalchemy-pt2)
  - [Flask-SQLAlchemy Lab](https://github.com/learn-co-curriculum/python-p4-flask-sqlalchemy-lab)
- [Conclusion to Flask Fundamentals](https://github.com/learn-co-curriculum/python-p4-conclusion-to-flask-fundamentals)

### Web Scraping

- [Scraping HTML with Beautiful Soup](https://github.com/learn-co-curriculum/python-p4-webscraping-beautiful-soup)
- [Object Oriented Scraping](https://github.com/learn-co-curriculum/python-scraping-code-along)
- [Scraping Kickstarter](https://github.com/learn-co-curriculum/python-scraping-kickstarter)

### Retrieving Data From APIs

- [Introduction to Getting Remote Data](https://github.com/learn-co-curriculum/python-p4-intro-to-remote-data)
- [Sending GET Requests](https://github.com/learn-co-curriculum/python-p4-sending-get-requests)
  - [Working with APIs](https://github.com/learn-co-curriculum/python-working-with-apis)
  - [Getting Remote Data Lab](https://github.com/learn-co-curriculum/python-getting-remote-data-lab)
- [Testing APIs with Postman](https://github.com/learn-co-curriculum/python-p4-getting-remote-data-postman)
- [Getting Remote Data Conclusion](https://github.com/learn-co-curriculum/python-p4-getting-remote-data-conclusion)

### Building APIs

- [Intro to Building APIs](https://github.com/learn-co-curriculum/python-p4-intro-to-building-apis)
  - [Building a GET API](https://github.com/learn-co-curriculum/python-p4-building-get-api)
  - [Building a GET API Lab](https://github.com/learn-co-curriculum/python-p4-building-get-api-lab)
  - [Building a POST/PATCH/DELETE API](https://github.com/learn-co-curriculum/python-p4-building-post-patch-delete-api)
  - [Building a POST/PATCH/DELETE API Lab](https://github.com/learn-co-curriculum/python-p4-building-post-patch-delete-api-lab)
  - [Chatterbox Lab](https://github.com/learn-co-curriculum/python-p4-chatterbox-lab)
- [Conclusion to Building APIs](https://github.com/learn-co-curriculum/python-p4-conclusion-to-building-apis)

### REST APIs

- [Intro to REST](https://github.com/learn-co-curriculum/python-p4-intro-to-rest)
  - [Create and Retrieve with Flask-RESTful](https://github.com/learn-co-curriculum/python-p4-flask-restful-cr)
  - [REST Create and Retrieve Lab](https://github.com/learn-co-curriculum/python-p4-flask-restful-cr-lab)
- [Error Handling In RESTful APIs](https://github.com/learn-co-curriculum/python-p4-rest-error-handling)
  - [Update and Delete with Flask-RESTful](https://github.com/learn-co-curriculum/python-p4-flask-restful-ud)
  - [REST CRUD Lab](https://github.com/learn-co-curriculum/python-p4-flask-restful-crud-lab)
- [Bonus: REST Philosophy](https://github.com/learn-co-curriculum/python-p4-rest-philosophy)
  - [Bonus: HATEOAS and Marshmallow](https://github.com/learn-co-curriculum/python-p4-hateoas-and-marshmallow)
- [Conclusion to REST](https://github.com/learn-co-curriculum/python-p4-conclusion-to-rest)

### Constraints and Validations

- [Intro to Constraints and Validations](https://github.com/learn-co-curriculum/python-p4-constraints-and-validations-intro)
- [SQLAlchemy Constraints](https://github.com/learn-co-curriculum/python-p4-validation-constraints)
- [SQLAlchemy Validations](https://github.com/learn-co-curriculum/python-p4-validation-flask-sqlalchemy-validations)
  - [SQLAlchemy Validations Lab](https://github.com/learn-co-curriculum/python-p4-validation-flask-sqlalchemy-validations-lab)
- [Validation Conclusion](https://github.com/learn-co-curriculum/python-validation-conclusion)

### Full-Stack Development

- [Intro to Full-Stack Development](https://github.com/learn-co-curriculum/python-p4-intro-to-full-stack-development)
  - [Adding React to Flask](https://github.com/learn-co-curriculum/python-p4-adding-react-to-flask)
  - [Adding React to Flask, Part 2](https://github.com/learn-co-curriculum/python-p4-adding-react-to-flask-pt-2)
  - [Formik and Form Validation](https://github.com/learn-co-curriculum/python-formik-validation)
- [Mini Lesson: TCP, HTTP, and Websocket](https://github.com/learn-co-curriculum/python-p4-tcp-http-and-websocket)
- [Conclusion to Full-Stack Development](https://github.com/learn-co-curriculum/python-p4-conclusion-to-full-stack-development)

### Identity and Access Management

- [Intro to Identity and Access Management](https://github.com/learn-co-curriculum/python-p4-intro-to-iam)
- [Cookies and Sessions](https://github.com/learn-co-curriculum/python-p4-login-sessions-cookies)
  - [Cookies in APIs](https://github.com/learn-co-curriculum/python-p4-cookies-in-flask-api)
  - [Cookies and Sessions Lab](https://github.com/learn-co-curriculum/python-p4-cookies-and-sessions-lab)
- [Authenticating Users](https://github.com/learn-co-curriculum/python-p4-authenticating-users)
  - [Authenticating Users Lab](https://github.com/learn-co-curriculum/python-p4-authenticating-users-lab)
- [Authorizing Requests](https://github.com/learn-co-curriculum/python-p4-authorization)
  - [Authorizing Requests Lab](https://github.com/learn-co-curriculum/python-p4-authorization-lab)
- [Password Protection](https://github.com/learn-co-curriculum/python-p4-passwords)
  - [Password Protection Lab](https://github.com/learn-co-curriculum/python-p4-passwords-lab)
  - [Putting it All Together: IAM Lab](https://github.com/learn-co-curriculum/python-p4-iam-putting-it-all-together-lab)
- [Conclusion to Identity and Access Management](https://github.com/learn-co-curriculum/python-p4-conclusion-to-iam)

### Deployment

- [Intro to Deployment](https://github.com/learn-co-curriculum/python-p4-intro-to-deployment)
- [Deploying a Flask API to Render](https://github.com/learn-co-curriculum/python-p4-deploying-flask-api-to-render)
- [Using Databases with Render](https://github.com/learn-co-curriculum/python-p4-using-databases-with-render)
  - [Deploying a Flask-React App to Render](https://github.com/learn-co-curriculum/python-p4-deploying-flask-react-app-to-render)
- [Conclusion to Deployment](https://github.com/learn-co-curriculum/python-p4-conclusion-to-deployment)

### Phase 4 Project

- [Phase 4 Project: Full-Stack Application](https://github.com/learn-co-curriculum/python-p4-phase-4-project)
